...
use glook\PecomSdk\Generated\Model\SuggestAddressResponseResponseGeoObjectCollection;
...
class SuggestAddressResponseResponseGeoObjectCollectionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'glook\PecomSdk\Generated\Model\SuggestAddressResponseResponseGeoObjectCollection' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'glook\PecomSdk\Generated\Model\SuggestAddressResponseResponseGeoObjectCollection' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new SuggestAddressResponseResponseGeoObjectCollection();
