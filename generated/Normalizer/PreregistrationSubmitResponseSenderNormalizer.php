...
class PreregistrationSubmitResponseSenderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'glook\\PecomSdk\\Generated\\Model\\PreregistrationSubmitResponseSender';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'glook\\PecomSdk\\Generated\\Model\\PreregistrationSubmitResponseSender';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \glook\PecomSdk\Generated\Model\PreregistrationSubmitResponseSender();
        ...
        if (\array_key_exists('coordinates', $data) && $data['coordinates'] !== null) {
            $object->setCoordinates($this->denormalizer->denormalize($data['coordinates'], 'glook\\PecomSdk\\Generated\\Model\\PreregistrationSubmitResponseSenderCoordinates', 'json', $context));
        }
