...
class BranchesFindzonebyaddressPostResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'glook\\PecomSdk\\Generated\\Model\\BranchesFindzonebyaddressPostResponse200';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'glook\\PecomSdk\\Generated\\Model\\BranchesFindzonebyaddressPostResponse200';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \glook\PecomSdk\Generated\Model\BranchesFindzonebyaddressPostResponse200();
        ...
        if (\array_key_exists('GeoData', $data)) {
            $object->setGeoData($this->denormalizer->denormalize($data['GeoData'], 'glook\\PecomSdk\\Generated\\Model\\BranchesGeoData', 'json', $context));
        }
        if (\array_key_exists('mainWarehouseId', $data)) {
            $object->setMainWarehouseId($data['mainWarehouseId']);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        $data['mainWarehouseId'] = $object->getMainWarehouseId();
