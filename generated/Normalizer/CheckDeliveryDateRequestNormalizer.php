...
class CheckDeliveryDateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'glook\PecomSdk\Generated\Model\CheckDeliveryDateRequest' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'glook\PecomSdk\Generated\Model\CheckDeliveryDateRequest' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new CheckDeliveryDateRequest();
        ...
        if (\array_key_exists('calculateDays', $data) && null !== $data['calculateDays']) {
            $object->setCalculateDays($data['calculateDays']);
        } elseif (\array_key_exists('calculateDays', $data) && null === $data['calculateDays']) {
        ...
        if (\array_key_exists('requestDateTime', $data) && null !== $data['requestDateTime']) {
            $object->setRequestDateTime(\DateTime::createFromFormat('Y-m-d', $data['requestDateTime'])->setTime(0, 0, 0));
        } elseif (\array_key_exists('requestDateTime', $data) && null === $data['requestDateTime']) {
