...
use glook\PecomSdk\Generated\Model\CargopickupnetworkServiceWithPayerAndPositions;
...
class CargopickupnetworkServiceWithPayerAndPositionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'glook\PecomSdk\Generated\Model\CargopickupnetworkServiceWithPayerAndPositions' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'glook\PecomSdk\Generated\Model\CargopickupnetworkServiceWithPayerAndPositions' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new CargopickupnetworkServiceWithPayerAndPositions();
