...
class BranchesChecknocalcservicesPostResponse200ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'glook\PecomSdk\Generated\Model\BranchesChecknocalcservicesPostResponse200Item' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'glook\PecomSdk\Generated\Model\BranchesChecknocalcservicesPostResponse200Item' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new BranchesChecknocalcservicesPostResponse200Item();
