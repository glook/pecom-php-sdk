...
use glook\PecomSdk\Generated\Model\ListAllOrderSenderCounterpart;
...
class ListAllOrderSenderCounterpartNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'glook\PecomSdk\Generated\Model\ListAllOrderSenderCounterpart' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'glook\PecomSdk\Generated\Model\ListAllOrderSenderCounterpart' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new ListAllOrderSenderCounterpart();
