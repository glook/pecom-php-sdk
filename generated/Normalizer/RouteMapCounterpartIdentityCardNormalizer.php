...
use glook\PecomSdk\Generated\Model\RouteMapCounterpartIdentityCard;
...
class RouteMapCounterpartIdentityCardNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'glook\PecomSdk\Generated\Model\RouteMapCounterpartIdentityCard' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'glook\PecomSdk\Generated\Model\RouteMapCounterpartIdentityCard' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new RouteMapCounterpartIdentityCard();
        ...
        if (\array_key_exists('typeName', $data) && null !== $data['typeName']) {
            $object->setTypeName($data['typeName']);
        } elseif (\array_key_exists('typeName', $data) && null === $data['typeName']) {
