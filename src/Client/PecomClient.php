...
class PecomClient
{
    ...
    {
        // Сгенерированный PHPDoc обещает null|ResponseInterface, потому что Jane
        // не выводит тип скалярного ответа из схемы. Реальный тип - строка.
        return $this->client->orderPrint($requestBody);
    }
}
